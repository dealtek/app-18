...
'RandomTests::TestRequestDate'=> $searchDateString,
...
These are recent random test selections and Completion Dates<br><br>
...
<?php foreach($rtemp_result->getRecords() as $rtemp_row){ ?>
<tr>
<td>
